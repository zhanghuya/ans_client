...
CREATE TABLE QUOTATION_CLAIM_SETTING_INFO (
    ...
    DUE_MONTH_STATUS VARCHAR(1),
    DUE_MONTH VARCHAR(255),
    DUE_DATE_STATUS VARCHAR(1),
    DUE_DATE DATE,
    WEEKEND_PREVIOUS_STATUS VARCHAR(1),
    WEEKEND_NEXT_STATUS VARCHAR(1),
    WEEKEND_IGNORE_STATUS VARCHAR(1),
...
ALTER TABLE PERSON_CHARGE_INFO ADD CONSTRAINT FK_QUOTATION_CLAIM_CREATION_ID FOREIGN KEY (QUOTATION_CLAIM_CREATION_ID) REFERENCES QUOTATION_CLAIM_CREATION_INFO(ID);
