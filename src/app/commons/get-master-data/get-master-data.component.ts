...
@Component({
  ...
  templateUrl: './get-master-data.component.html',
  styleUrl: './get-master-data.component.css'
})
export class GetMasterDataComponent  implements OnInit {
